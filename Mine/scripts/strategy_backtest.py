...
try:
    ...
    spec = importlib.util.spec_from_file_location("HighLowSignal", os.path.join(os.path.dirname(__file__), "..", "src", "trading_app", "strategy", "Live", "HighLowSignal.py"))
    ...
    spec_service = importlib.util.spec_from_file_location("OptionsChartService", os.path.join(os.path.dirname(__file__), "..", "src", "trading_app", "service", "options_chart_service.py"))

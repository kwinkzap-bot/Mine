...
echo "2. Configure WhatsApp notifications (see below)"
echo "3. Run: python run.py"
echo "4. Visit: http://127.0.0.1:5000"
echo ""
echo "WhatsApp Notification Setup:"
echo "1. Get your credentials from https://developers.facebook.com/"
echo "2. Set environment variables:"
echo "   export WHATSAPP_TOKEN='your_access_token'"
echo "   export WHATSAPP_PHONE_NUMBER_ID='your_phone_number_id'"
echo "   export WHATSAPP_TO_NUMBER='918880802168'"
echo ""
echo "Documentation:"
